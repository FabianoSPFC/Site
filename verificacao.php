...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        for ($i = 0; $i < count($questao); $i++) {
            ...
            echo "<p>Imagem:
                    <img src=imagens/" . $arr_questoes[$i]->getCaminho() . " alt=' Algum erro aconteceu'>
                </p><br>";
            echo "<p>Caminho:" . $arr_questoes[$i]->getCaminho() . "</p><br>";
            echo "<p>Letra A: " . $arr_questoes[$i]->getLetra_A() . "</p><br>";
            echo "<p>Letra B: " . $arr_questoes[$i]->getLetra_B() . "</p><br>";
            echo "<p>Letra C: " . $arr_questoes[$i]->getLetra_C() . "</p><br>";
            echo "<p>Letra D: " . $arr_questoes[$i]->getLetra_D() . "</p><br>";
            echo "<p>Letra E: " . $arr_questoes[$i]->getLetra_E() . "</p><br>";
            echo "<p>Dificuldade: " . $arr_questoes[$i]->getNivel_dificuldade() . "</p><br>";
            $sql = $arr_questoes[$i]->sql($conection->getDatabase());
            echo $sql;
            if (mysqli_query($link, $sql) == true) {
                echo "Deu tudo certo no banco de dados!";
            } else {
